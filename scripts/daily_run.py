...
def build_final_summary(runtime_bundle: RuntimeConfigBundle, context: RunContext) -> DictStrAny:
    ...
    summary = {
        ...
        "market_brain": dict(context.daily_briefing_payload.get("market_brain", {})),
        "analysis_critic": dict(context.daily_briefing_payload.get("analysis_critic", {})),
        "telegram_native_brief": dict(context.daily_briefing_payload.get("telegram_native_brief", {})),
