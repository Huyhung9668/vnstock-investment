...
- Ưu tiên khi giá vượt hoặc giữ được trên vùng cản gần 48.5.
- Thanh khoản duy trì tích cực, không suy yếu rõ rệt so với các phiên gần nhất.

## Invalidation
- `invalidation`: Thesis bị vô hiệu nếu giá thủng rõ ràng vùng hỗ trợ 44.04 với áp lực bán tăng.
...
- Cân nhắc chốt một phần khi tiệm cận target 1 = 48.5.
