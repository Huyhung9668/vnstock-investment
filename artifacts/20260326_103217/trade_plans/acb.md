...
## Thesis
- `thesis`: Xu hướng hiện tại nghiêng về downtrend. Động lượng đang ở trạng thái negative.
...
- Ưu tiên khi giá vượt hoặc giữ được trên vùng cản gần 25.85.

## Invalidation
- `invalidation`: Thesis bị vô hiệu nếu giá thủng rõ ràng vùng hỗ trợ 22.09 với áp lực bán tăng.
...
- Cân nhắc chốt một phần khi tiệm cận target 1 = 25.85.
