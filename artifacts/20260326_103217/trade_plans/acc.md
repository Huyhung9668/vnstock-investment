...
## Thesis
- `thesis`: Xu hướng hiện tại nghiêng về downtrend. Động lượng đang ở trạng thái weak.
...
- Ưu tiên khi giá vượt hoặc giữ được trên vùng cản gần 13.42.

## Invalidation
- `invalidation`: Thesis bị vô hiệu nếu giá thủng rõ ràng vùng hỗ trợ 11.7 với áp lực bán tăng.
...
- Cân nhắc chốt một phần khi tiệm cận target 1 = 13.42.
