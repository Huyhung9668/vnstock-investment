...
| AAA | breakout_or_wait | wait | n/a | Thesis bị vô hiệu nếu cấu trúc giá xấu đi và động lượng chuyển sang tiêu cực. | True |
...
| --- | --- | --- | --- |
| macro_context | ready | True | Độ rộng thị trường yếu, bên giảm giá chiếm ưu thế và dòng tiền phòng thủ hơn. Do rong thi truong positive_ratio = 0.1. |
| futures_radar | proxy | True | futures_radar |
| flow_of_funds | ready | True | Dong tien hien dang tap trung vao nhom dan dat: ACB, AAA, ANV. Muc tap trung thanh khoan = 1. |
| stock_scanner | ready | True | Scanner chon ra nhom uu tien: ACB, ACC, ABS, AAA, ANV. |
| technical_profiler | ready | True | Technical profiler da lap ho so cho 6 symbol. |
| fundamental_profiler | ready | True | Fundamental profiler co du lieu tai chinh cho 6/6 symbol. |
| risk_engine | ready | True | Risk engine danh gia portfolio risk = elevated. |
| portfolio_auditor | ready | True | Portfolio auditor de xuat posture = defensive. Co 6 setup can giam size hoac quan sat them. |
