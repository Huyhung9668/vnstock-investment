...
## Thesis
- `thesis`: Xu hướng hiện tại nghiêng về downtrend.
...
- Ưu tiên khi giá vượt/giữ được trên vùng cản gần 38.17.

## Invalidation
- `invalidation`: Thesis bị vô hiệu nếu giá thủng rõ ràng vùng hỗ trợ 33.0 với áp lực bán tăng.
...
- Cân nhắc chốt một phần khi tiệm cận target 1 = 38.17.
