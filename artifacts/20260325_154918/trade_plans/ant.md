...
- Ưu tiên khi giá vượt/giữ được trên vùng cản gần 38.45.
- Thanh khoản duy trì tích cực, không suy yếu rõ rệt so với các phiên gần nhất.

## Invalidation
- `invalidation`: Thesis bị vô hiệu nếu giá thủng rõ ràng vùng hỗ trợ 32.85 với áp lực bán tăng.
...
- Cân nhắc chốt một phần khi tiệm cận target 1 = 38.45.
