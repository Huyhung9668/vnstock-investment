...
## Thesis
- `thesis`: Xu hướng hiện tại nghiêng về xu hướng tăng. Động lượng đang ở trạng thái tích cực vừa phải.
...
- Ưu tiên khi giá vượt hoặc giữ được trên vùng cản gần 32.84.
- Thanh khoản duy trì tích cực, không suy yếu rõ rệt so với các phiên gần nhất.

## Invalidation
- `invalidation`: Thesis bị vô hiệu nếu giá thủng rõ ràng vùng hỗ trợ 28.06 với áp lực bán tăng.
...
- Cân nhắc chốt một phần khi tiệm cận target 1 = 32.84.
