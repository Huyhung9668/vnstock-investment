...
## Thesis
- `thesis`: Xu hướng hiện tại nghiêng về xu hướng giảm. Động lượng đang ở trạng thái tích cực.
...
- Ưu tiên khi giá vượt hoặc giữ được trên vùng cản gần 19.58.
- Thanh khoản duy trì tích cực, không suy yếu rõ rệt so với các phiên gần nhất.

## Invalidation
- `invalidation`: Thesis bị vô hiệu nếu giá thủng rõ ràng vùng hỗ trợ 16.73 với áp lực bán tăng.
...
- Cân nhắc chốt một phần khi tiệm cận target 1 = 19.58.
