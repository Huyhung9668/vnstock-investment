...
## Thesis
- `thesis`: Xu hướng hiện tại nghiêng về xu hướng giảm. Động lượng đang ở trạng thái tiêu cực.

## Setup Type
- `setup_type`: avoid_or_wait
...
- Ưu tiên khi giá vượt hoặc giữ được trên vùng cản gần 25.69.

## Invalidation
- `invalidation`: Thesis bị vô hiệu nếu giá thủng rõ ràng vùng hỗ trợ 21.95 với áp lực bán tăng.
...
- Cân nhắc chốt một phần khi tiệm cận target 1 = 25.69.
